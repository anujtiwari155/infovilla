...
<html lang="en">
    <head>
        ...
        <title><?php if (isset($title) and $title != '') echo $title; else 'Profile Page - Material Kit by Creative Tim' ?></title>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <!-- <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('vendor/Vendorfunction/category') ?>">Catogories</a></li>
                                <li><a href="<?= base_url('vendor/Vendorfunction/attribute') ?>">Attributes</a></li>
                                <li><a href="<?= base_url('vendor/Vendorfunction/add_brand') ?>">Brands</a></li>
                            </ul>
                        </li> -->
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('vendor/Vendorfunction/product/validate_product') ?>">Add Products</a></li>
                                <li><a href="<?= base_url('vendor/Vendorfunction/product/all') ?>">All Products</a></li>
                                <li><a href="<?= base_url('vendor/Vendorfunction/product/pending_products') ?>">Pending  Product</a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li class="dropdown">
                            <a href="#" data-target="#" class="dropdown-toggle" data-toggle="dropdown">Reports
                                <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('vendor/VendorReport/order_list') ?>">Order Report</a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown"><?= (isset($current_user_details) && $current_user_details->first_name != '')  ? $current_user_details->first_name : 'Guest'?>
                              <span class="caret"></span></button>
                              <ul class="dropdown-menu">
                                <li><a href="<?= base_url('logout/vendor') ?>">Logout</a></li>
                                <li><a href="<?= base_url('vendor/Vendorfunction/vendor/edit_profile') ?>">Edit Profile</a></li>
                              </ul>
                        </li>
                    </ul>
                </div>
