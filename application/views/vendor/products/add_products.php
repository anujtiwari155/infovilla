      ...
      <form action="<?= $action ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-12">
            <div class="col-md-5">
                <div class="form-group label-floating">
                  ...
                  <input type="text" class="form-control" <?= isset($product->code) ? 'disabled' : 'name="code"' ?>  onchange="Validate_vendor.product(this.value)" value="<?= isset($product->code) ? $product->code : $pro_code ?>" readonly  id="product_code">
            ...
            <div class="col-md-5 col-md-offset-1">
                <div class="form-group label-floating">
                  ...
                  <input type="text" class="form-control" onblur="Validate.product(this.value)" value="<?= isset($product->name) ? $product->name : '' ?>" name="name" id="product_name">
                  <p class="help-block" style="display:none" id="product_error">This product <code>already exist</code></p>
                </div>
            </div>
            <div class="col-md-5">
                <div class="form-group label-floating">
            ...
            <div class="col-md-5">
              <?php if(!isset($product)) { ?>
                <div class="form-group label-floating">
                  <label for="sort_description2" class="control-label">Quantity</label>
                  <input type="number" class="form-control" value="<?= isset($product->inventory->quantities) ? $product->inventory->quantities : '' ?>" name="quantity" id="sort_description2">
        ...
        <div class="row">
          ...
          <div class="col-md-12" id="sub_category_2">
            <div class="col-md-3 new_category_2">
              <div class="form-group">
                ...
                <select id="parent_id_1" key="1" name="parent_id[]" onchange="Category.vendor_category_select(this.value , this.id , 2,2)" class="form-control">
									<option value="">&nbsp;</option>
          ...
          <div class="col-md-12">
            <div class="col-md-6">
              <div class="form-group label-floating">
                <label for="cost_price" class="control-label">Cost Price<span>*</span></label>
                <input type="text" class="form-control" value="<?= isset($current_inventory->cost_price) ? $current_inventory->cost_price : '' ?>" name="cost_price" id="cost_price">
                <p class="help-block">Please enter <code>Cost Price</code></p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group label-floating">
                <label for="product_code" class="control-label">MRP<span>*</span></label>
                <input type="text" class="form-control" value="<?= isset($current_inventory->mrp) ? $current_inventory->mrp : '' ?>" name="mrp" id="product_code">
